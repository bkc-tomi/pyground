...
urlpatterns = [
    ...
    path('register/complete/<token>/', views.register_complete, name='register_complete'),
    path('run/register/'             , views.run_register     , name='run_register'),
    path('login/'                    , views.login            , name='login'),
    path('run/login/'                , views.run_login        , name='run_login'),
    path('<int:user_id>/run/logout/' , views.run_logout       , name='run_logout'),
    path('withdrawal/'               , views.withdrawal       , name='withdrawal'),
    path('run/withdrawal/'           , views.run_withdrawal   , name='run_withdrawal'),
